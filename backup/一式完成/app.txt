...
BACKGROUND_IMAGE = PROJECT_ROOT / "ui" / "assets" / "backdesign.png"
APP_ICON = PROJECT_ROOT / "ui" / "assets" / "cat_elf_app_icon.ico"
...
class LauncherWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        card_guilds_card = self._make_editor_card(
            title="カルテ作成リスト",
        )
        ...
        guilds_card = self._make_editor_card(
            title="データ取得",
        )
    ...
    def _apply_styles(self) -> None:
        self.setStyleSheet(
            ...
            QFrame#blueCard {
                background-color: rgba(218, 247, 246, 185);
            }
            ...
            QPushButton#headerButton:hover {
                background-color: rgba(217, 140, 179, 230);
            }

            QPushButton#headerButton:pressed {
                background-color: rgba(201, 119, 162, 235);
            }
            ...
            QPushButton#topActionButton:hover {
                background-color: rgba(232, 168, 200, 230);
            }
            ...
            QTextEdit#logView {
                background-color: rgba(220, 248, 247, 180);
            }
    ...
    def start_next_script(self) -> None:
        ...
        self.append_log(f"> {sys.executable} {script_path.relative_to(PROJECT_ROOT)}")
